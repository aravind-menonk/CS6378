...
public class ClientOne {
	...
	public ClientOne(String address, int port){
		try {
		...
		//Base file path for Client 1
		String baseFilePath = "/home/012/a/ax/axk210275/D1/client1/";
		/*
		...
		try{
			...
			InputStream is = new FileInputStream(baseFilePath + "F1.txt");
	...
	public static void main(String args[]){
		ClientOne client = new ClientOne("10.176.69.32", 5056);
	}
}
